...
def main():
    ...
    while True:
        ...
        pred_label = labels[best_idx] if best_idx < len(labels) else f"Class_{best_idx}"
        ...
        for i, label in enumerate(labels):
            ...
            cv2.rectangle(frame, (140, y_pos - 10), (140 + bar_width, y_pos), colors.get(label, (255, 255, 255)), -1)
            # Draw percentage
