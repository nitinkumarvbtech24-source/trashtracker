...
filepath = 'e:/vc code/.vscode/trash tracker/AIQ_Fleet app/lib/ui/reports_screen.dart'

new_reports_screen = """import 'package:flutter/material.dart';
...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String displayDate = DateFormat('MMM dd, yyyy').format(_selectedDate);
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
            ...
            label: Text(displayDate, style: const TextStyle(color: Colors.blueAccent)),
            onPressed: _pickDate,
          ),
        ],
      ),
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('No trips recorded on $displayDate', style: GoogleFonts.inter(color: Colors.white54, fontSize: 16)),
                        ],
                      ),
                    )
                  : ListView.builder(
...
with open(filepath, 'w', encoding='utf-8') as f:
    f.write(new_reports_screen)
print("Updated reports_screen.dart")
